...
const getSensibleMoves = (game: Game): Move[] => {
...
const getOptimalMoves = (game: Game): Move[] => {
...
export const getOptimalMove = (game: Game): Move => {
